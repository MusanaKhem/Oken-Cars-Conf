...
# test_build-on_server-from_repository.sh

#=============================================================================
# WHEN THE REPOSIRTORY DO NOT EXIST ON 10.10.10.31 DEPLOYMENT SERVER
#=============================================================================
...
git clone --branch develop --single-branch ssh://git@10.10.10.212:2222/oken-con>
